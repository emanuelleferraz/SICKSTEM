                        ...
                        <form method="post" action="editarMedico_script.php">
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="crm" name="CRM" required value="<?php echo $linha['CRM']; ?>">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="especialidade" name="Especialidade" required value="<?php echo $linha['Especialidade']; ?>">
                                </div>
                            </div>
                            <div class="form-row">
