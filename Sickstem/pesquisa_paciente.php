...
<head>
    ...
    <!-- Title -->
    <title>SICKSTEM - Listar Pacientes</title>
        ...
        <div class="row">
            <div class="col-12">
                <div class="border rounded-3 p-5  mt-5 shadow box-area">
                    <h1>Pesquisar Pacientes</h1><br>
                    <nav class="navbar bg-body-tertiary">
                        <div class="container-fluid">
                            <form class="d-flex" role="search" action="pesquisa_paciente.php" method="POST">
                        ...
                        <tbody>
                            ...
                            while ($linha = mysqli_fetch_assoc($dados)) {
                                ...
                                echo "<tr>
                                            ...
                                            <td>$telefone</td>
											<td>
                                                <a href='editarPaciente.php?id=$cpf' class='text-white btn btn-danger btn-sm')>Editar</a>
